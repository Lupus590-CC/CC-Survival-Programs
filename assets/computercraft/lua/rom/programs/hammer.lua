...
settings.define("lupus590.hammer.input_chest", {
    description = "The peripheral name of the chest to input from.",
    type = "string",
})

settings.define("lupus590.hammer.output_chest", {
    description = "The peripheral name of the chest to output into.",
    type = "string",
})

settings.define("lupus590.hammer.pass_through_junk", {
...
local INPUT_CHEST_NAME = settings.get("lupus590.hammer.input_chest") or error("Input chest is not set, use the set command and set lupus590.hammer.input_chest to a valid networked peripheral.", 0)
local OUTPUT_CHEST_NAME = settings.get("lupus590.hammer.output_chest") or error("Output chest is not set, use the set command and set lupus590.hammer.output_chest to a valid networked peripheral.", 0)
local PASS_THROUGH_JUNK = settings.get("lupus590.hammer.pass_through_junk")
